  ...
  return (
    <Card className="border-slate-200/60 dark:border-slate-700/60 bg-white/90 dark:bg-slate-700/90 backdrop-blur-sm">
      <CardHeader className="pb-4">
        <CardTitle className="text-base sm:text-lg text-blue-900 dark:text-blue-100">Recommendation Method</CardTitle>
      ...
      <CardContent>
        <RadioGroup
          ...
          className="space-y-3"
        >
          <div className="flex items-center space-x-3 p-2 sm:p-3 rounded-lg border border-slate-200/60 dark:border-slate-600/60 hover:bg-slate-50 dark:hover:bg-slate-600/50 transition-colors">
            <RadioGroupItem value="fragrances" id="fragrances" />
            <Heart className="h-4 w-4 text-blue-700 flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <Label
                htmlFor="fragrances"
                className="font-medium cursor-pointer text-blue-900 dark:text-blue-100 text-sm"
              >
          ...
          <div className="flex items-center space-x-3 p-2 sm:p-3 rounded-lg border border-slate-200/60 dark:border-slate-600/60 hover:bg-slate-50 dark:hover:bg-slate-600/50 transition-colors">
            ...
            <Palette className="h-4 w-4 text-blue-700 flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <Label htmlFor="accords" className="font-medium cursor-pointer text-blue-900 dark:text-blue-100 text-sm">
