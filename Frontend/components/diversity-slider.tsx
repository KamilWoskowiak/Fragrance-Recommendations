    ...
    <Card className="border-slate-200/60 dark:border-slate-700/60 bg-white/90 dark:bg-slate-700/90 backdrop-blur-sm">
      <CardHeader className="pb-4">
        <CardTitle className="text-base sm:text-lg flex items-center text-blue-900 dark:text-blue-100">
          <Shuffle className="mr-2 h-4 w-4 sm:h-5 sm:w-5 text-blue-700 flex-shrink-0" />
          Diversity Factor
        </CardTitle>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <Label htmlFor="diversity" className="font-medium text-blue-900 dark:text-blue-100 text-sm">
            Diversity Level
          </Label>
